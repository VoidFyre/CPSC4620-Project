...
-- CREATING PROCEDURES
	...
	DROP PROCEDURE IF EXISTS `ADDPIZZA`;
	DROP PROCEDURE IF EXISTS `UPDATECUSTOMERADDRESS`;
	DROP PROCEDURE IF EXISTS `UPDATEORDERIN`;
	DROP PROCEDURE IF EXISTS `UPDATEORDEROUT`;
	DROP PROCEDURE IF EXISTS `UPDATEPIZZATOPPINGS`;
DELIMITER //
...
CREATE PROCEDURE `UPDATEPIZZATOPPINGS`()
BEGIN
	UPDATE pizza
	SET PizzaPrice = (
		SELECT
